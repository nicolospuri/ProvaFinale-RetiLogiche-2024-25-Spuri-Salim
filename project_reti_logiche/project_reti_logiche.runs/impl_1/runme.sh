...
HD_PWD='C:/Users/Nicky/Desktop/POLIMI/Corsi/ProveFinali/RL/project_reti_logiche/project_reti_logiche.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_reti_logiche.vdi -applog -m64 -messageDb vivado.pb -mode batch -source project_reti_logiche.tcl -notrace
